...
```text
Continue the active Domino workflow and run final verification now. Read `.cursor/domino-plan.md`, `.cursor/domino-runtime.json`, and the latest task results before acting.
```
